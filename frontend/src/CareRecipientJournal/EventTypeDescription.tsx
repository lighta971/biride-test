...
const descriptionDictionnary = {
  hadObservations:
    'Your beloved one is being well taken care of; the nurses have made various observations, ranging from general observations to those regarding mental health, incontinence pads, and catheters. These observations help the care provider to enhance the quality of life for your beloved one.',
  ...
  hadMedicationProblem:
    'Your parent may have difficulty taking their medication. A nurse will provide follow-up support to help them take it as prescribed.',
  hadAlertOrConcern:
...
const titleDictionnary = {
  ...
  hadVisit: 'Receive visits',
  foodOrFluidIntakeChecked: 'Alimentation verified',
  hadMedicationProblem: 'Medication problem',
