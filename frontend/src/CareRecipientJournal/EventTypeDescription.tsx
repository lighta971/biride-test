...
const descriptionDictionnary = {
  hadObservations:
    'The nurses have made various observations, ranging from general observations to those regarding mental health, incontinence pads, and catheters. These observations help the care provider to enhance the quality of life for your parent.',
  hadVisit: 'Your parent have had visitors today.',
  foodOrFluidIntakeChecked:
    "A nurse has been monitoring your parent's food and liquid intake, as seniors experience a decrease in appetite and sometimes a loss of taste, as well as feeling less thirsty.",
  ...
  hadAlertOrConcern:
    'Some concern has been raised about your parent, and we are looking into it. We will contact you to provide more information.',
  checkedIn: 'Your parent checked into the care facility and entered his room.',
  checkedOut: 'Your parent has left the care facility.',
  observedMood: "We observed your parent's mood and noticed that he seemed to be",
}
