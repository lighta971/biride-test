...
describe('EventTypeDescription', () => {
  it.each`
    ...
    ${'foodOrFluidIntakeChecked'} | ${`A nurse has been monitoring your parent's food and`}
  ...
  it('render observed mood description with given mood', () => {
    ...
    // assert
    const expectedText = `We observed your parent's mood and noticed that he seemed to be happy`
    expect(screen.getByText(new RegExp(expectedText))).toBeInTheDocument()
  })
})
